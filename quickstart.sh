...
echo ""
echo "Step 6: Direct AIG to PT Conversion (One-Step)"
echo "----------------------------------------------"
./ai4eda-toolkit convert aig2pt test_data/aig/cavlc.aig test_data/pt/cavlc_onestep.pt
echo "✓ Completed"
...
echo "  - PT Direct: test_data/pt/cavlc_onestep.pt"
